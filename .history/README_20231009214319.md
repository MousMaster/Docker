...
Dans le cadre de ce projet, dont les spécifications sont disponibles [ici](https://github.com/diranetafen/student-list.git "here"). J'ai due conteneuriser une mini aplication devellope en architecture micro service. Le backend etant devellope en python et le front end en php.
