...
J'ai choisi de creer deux reseau un pour l'application a dockeriser et un deuxieme pour le registre docker deployer en local qui est compose d'un backend et d'un frontend. 
