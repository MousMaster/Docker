...
Apres genere le fichier docker-compose , il faut modifier la ligne 
```console
...
```
pour que le front end pointe sur le backend pour cela il faut remplacer api_ip par le nom du conteneur ici c'est student-api et port par notre port expose et ici c'est 8082.