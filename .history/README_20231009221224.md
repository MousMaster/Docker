...
Pour réaliser les taches demandé il faut d'abord commencer par créer l'image docker de l'api en python en créant un dockerfile puis de deployer cette meme image et de tester avec un commande curl comme demande dans l'ennonce.
